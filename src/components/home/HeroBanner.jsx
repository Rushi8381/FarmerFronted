      ...
      <div className="flex px-10 gap-x-10 items-center justify-between w-full">
        <div className="w-1/2 mt-20">
          <h1 className="text-4xl font-medium">
            ...
            <span className="text-theme3">{HomeData[lang].shetkariMitra}</span>
          </h1>
          ...
          <div className="flex gap-x-5 mt-16">
            ...
            <Link
              to={"/signup"}
              className="px-4 py-[6px] text-[16px] border-theme border bg-theme text-white hover:bg-transparent hover:text-theme duration-200 ease-in-out"
            >
              {HomeData[lang].getStarted}
            </Link>
          </div>
        </div>

          <img src={HeroBannerImg} alt="hero banner img" width={400} className="mt-10" />
      </div>
