  ...
  return (
    <div className="pb-10">
      ...
      <h1 className="text-3xl font-semibold text-center mb-10">
        {FarmerData[lang].book} <span className="text-theme3">{FarmerData[lang].vehicle}</span>
      </h1>
          ...
          return (
            ...
            >
              <div className="w-full h-[150px] p-1 relative">
                ...
                />
                <div className="absolute top-5 right-5 bg-theme3 rounded-full w-9 h-9 flex items-center justify-center">
